...
/**
 * Created by hassan on 6/24/2017.
 */
...
public class IngredientListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            ...
            View rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ingredients_list_item, parent, false);
    ...
    static class IngredientViewHolder extends RecyclerView.ViewHolder {
        ...
        public IngredientViewHolder(View itemView) {
            super(itemView);
            mIngredient = (TextView) itemView.findViewById(R.id.tv_ingredient);
